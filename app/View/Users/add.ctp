...
<?php echo $this->Form->create('User', array(
	...
	?>
		...
		<label for="UserCopy" class="col-lg-2 control-label">Attachment</label>
		<div class="col-lg-3">
			<div class="input file">
				<input type="file" name="data[User][copy]" class="form-control" id="UserCopy"/>
				<small><i>Please upload a copy of your MyKad</i></small>
			</div>
			</div>
		</div>
