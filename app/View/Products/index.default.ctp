<div class="products index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('pictures'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($product['Product']['manufacturer']); ?>&nbsp;</td>
		<td><?php echo h($product['Product']['wholeseller_price']); ?>&nbsp;</td>
		<td><?php echo h($product['Product']['agent_price']); ?>&nbsp;</td>
		<td><?php echo h($product['Product']['isActive']); ?>&nbsp;</td>
		<td><?php echo h($product['Product']['pictures']); ?>&nbsp;</td>
		<td><?php echo h($product['Product']['created_on']); ?>&nbsp;</td>
		<td class="actions">
